...
//
//	mockgen --build_flags=--mod=mod -destination /home/etienne/Documents/Scalingo/golang/src/github.com/Scalingo/go-utils/otel/otelmock/float64histogram.go -package otelmock go.opentelemetry.io/otel/metric Float64Histogram
//
...
func (m *MockFloat64Histogram) Enabled(arg0 context.Context) bool {
	m.ctrl.T.Helper()
...
func (mr *MockFloat64HistogramMockRecorder) Enabled(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enabled", reflect.TypeOf((*MockFloat64Histogram)(nil).Enabled), arg0)
}
